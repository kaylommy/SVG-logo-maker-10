...
describe('shapes', () =>{
    ...
    describe('Circle', ()=>{
        ...
        it('should render a circle shape', ()=> {
            const circle = new Circle('hi', 'blue', 'green')
    ...
    describe('Square', ()=>{
        ...
        it('should render a square shape', ()=> {
            const square = new Square('hi', 'blue', 'green')
            expect(square.render()).toBe(`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="300" height="200"><rect width="300" height="200" x="10" y="10" width="30" height="30" stroke="black" fill="${square.shapeColor}" stroke-width="5"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="${square.textColor}">${square.logoText}</text></svg>`)
        })
    })
